 ...
 */
public abstract class ElementEditorContribution {
	 ...
	 * 
	 * @param parent
	 *            the Composite in the {@link CTabItem} created for this
	 *            contribution
	 * @param context
	 ...
	 * @param editingDomain
	 */
	public abstract void createContributedForm(Composite parent, EMFDataBindingContext context, WritableValue master, EditingDomain editingDomain);
